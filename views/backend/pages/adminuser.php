                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="<?= base_url();?>index.php/admin-user"  id="registrationForm" method="POST" class="user">
                                ...
                                <button name="adminbtn" type="submit" class="btn btn-primary btn-user btn-block">
                                    Register Account
</button>                                     
                                <hr>
