            ...
            <hr style="border: -1.5px solid #ccc; margin-top: 0px;">
                ...
                <div class="form-row" style="text-align: left;">
                    <div class="form-group col" style="margin: 10px;">
                        ...
                        <select style="border-radius: 3px" value="<?php echo $resident_data->purok; ?>" name="purok" id="purok" class="form-control" required>
                            <?php for ($i = 1; $i <= 7; $i++) { ?>
                ...
                <div class="form-row" style="text-align: left;">
                    <div class="form-group col" style="margin: 10px;">
                        ...
                        <select name="sex" value="<?php echo $resident_data->sex; ?>" style="border-radius: 3px" id="sex" class="form-control" required>
